...
On the drift side no enforcement is imposed: paths follow the field of the solved
potential, whose no-flux boundary is the only condition, and the drift endtag is
always \code{DRIFT\_NONE} --- a bookkeeping label kept for call-site
compatibility, not a term in the field equation.
