...
$PY compute_chamfer_removed.py --store "$STORE" --mode dynamic --spacing 0.1 --chamfer-mm 0.4 \
    --pad-z 10 --drift 20 --total 30 --cathode -1000 \
    --title "Task 4 -- 2 cm drift, 0.1 mm, dynamic 0.4 mm chamfer (equivalence proof)"
